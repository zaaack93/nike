...
const Hero = () => {
  ...
  return (
    <section id="hero" className="w-full flex xl:flex-row flex-col justify-center gap-10 min-h-screen max-container">
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {
            statistics.map((statistic, index) => (
              <div key={index} className="flex flex-col justify-center items-center gap-2">
                ...
                <p className="leading-8 font-montserrat text-slate-gray">{statistic.label}</p>
              </div>
            ))
          }
        </div>
